...
/*
  Differentiation of call_price in reverse (adjoint) mode:
   ...
   RW status of diff variables: v:incr call_price:in-killed K:incr
                S:incr T:incr
*/
void call_price_b2(double S, double *Sb, double K, double *Kb, double v, double
        *vb, double T, double *Tb, double call_priceb, double *call_priced) {
    ...
    *call_priced = S*result1 - K * result2;
    if (!(T==0.0))
