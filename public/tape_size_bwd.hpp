#ifndef NEW_TAPE_SIZE_BWD_HPP
#define NEW_TAPE_SIZE_BWD_HPP
...
constexpr static auto tape_size(const args<double_t<N> const> &, const args<> &,
                                const args<Leaves...> &) -> std::size_t {
    return has_type2<double_t<N> const, Leaves...>();
}
